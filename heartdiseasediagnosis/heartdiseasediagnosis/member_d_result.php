...
<body>
<?php $_SESSION['disease'] = $row_disease['disease']; 
 ...
 $_SESSION['medication'] = $row_disease['medication']; 
  ...
  mysql_query("insert into users_test(username,password,disease,treatment,medication) values('$username','$password','$disease','$treatment','$medication')");
  ?>
<div id="art-main">
