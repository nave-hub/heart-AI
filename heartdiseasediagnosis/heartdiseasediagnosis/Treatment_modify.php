...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE treatment SET treatment=%s WHERE id=%s",
...
mysql_select_db($database_config, $config);
$query_Recordset1 = sprintf("SELECT id, treatment, medication FROM treatment WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table width="623" height="258" align="center" class="a">
    <tr valign="baseline">
      <td width="187" height="225" align="left" valign="middle" nowrap="nowrap">Treatment/ Medication:</td>
      <td width="424" align="left" valign="middle"><textarea name="treatment" cols="60" rows="12"><?php echo htmlentities($row_Recordset1['treatment'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
    </tr>
    <tr valign="baseline">
      <td align="left" valign="middle" nowrap="nowrap">&nbsp;</td>
      <td align="left" valign="middle"><input type="submit" value="Update" /></td>
    </tr>
  </table>
